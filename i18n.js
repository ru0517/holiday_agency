(function () {
  ...
  var STR = {
    ru: {
      ...
      "meta.desc":
        "Люксовое путешествие по Азербайджану с Tourelax — виллы, VIP-транспорт, гид. Тур с 20 по 30 июля. 7500 zł.",
      ...
      "map.gala.t": "Водопад Галачик (Qalacıq)",
      "map.gala.n": "Природа и пикник",
      "map.karan.t": "Озеро Каранохур",
      "map.karan.n": "Горное озеро",
      "map.qum.t": "Базилика в Куме",
      "map.qum.n": "V век, район Ках",
      "map.ilisu.t": "Илису",
      "map.ilisu.n": "Деревня, озеро",
      "map.karvansaray.t": "Караван-сарай",
      "map.karvansaray.n": "Шеки, шёлковый путь",
      "map.kishtemple.t": "Албанский храм в Кише",
      "map.kishtemple.n": "Древняя церковь",
      "map.kishv.t": "Киш",
      "map.kishv.n": "Посёлок у храма",
      "map.shekipalace.t": "Дворец шекинских ханов",
      "map.shekipalace.n": "XVIII в., шебеке",
      "map.vizezemin.t": "Визеземин",
      "map.vizezemin.n": "Лерик, деревня на маршруте",
      "map.yard.t": "Каньон Нисекала",
      "map.yard.n": "Ярдимли, водопады",
      "map.hirkanpark.t": "Нац. парк Хиркан",
      "map.hirkanpark.n": "Леса и тропы",
      "map.sim.t": "Водопад Сым",
      "map.sim.n": "Хиркан, пикник",
      "map.hamosham.t": "Хамошам",
      "map.hamosham.n": "Вершина, вид",
      "map.qakh.t": "Ках",
    ...
    pl: {
      ...
      "meta.desc":
        "Luksusowa podróż po Azerbejdżanie z Tourelax — wille, transport VIP, przewodnik. Tur 20–30 lipca. 7500 zł.",
      ...
      "map.gala.t": "Wodospad Galach (Qalacıq)",
      "map.gala.n": "Natura i piknik",
      "map.karan.t": "Jezioro Karanohur",
      "map.karan.n": "Górskie jezioro",
      "map.qum.t": "Bazylika w Kum",
      "map.qum.n": "V w., region Kach",
      "map.ilisu.t": "Ilisu",
      "map.ilisu.n": "Wioska, jezioro",
      "map.karvansaray.t": "Karawansaraj",
      "map.karvansaray.n": "Szeki, Jedwabny Szlak",
      "map.kishtemple.t": "Kościół albański w Kisz",
      "map.kishtemple.n": "Starochrześcijańska świątynia",
      "map.kishv.t": "Kisz",
      "map.kishv.n": "Miejscowość przy świątyni",
      "map.shekipalace.t": "Pałac chanów szekińskich",
      "map.shekipalace.n": "XVIII w., szebeka",
      "map.vizezemin.t": "Wizezemin",
      "map.vizezemin.n": "Lerik, wioska na trasie",
      "map.yard.t": "Kanion Nisakala",
      "map.yard.n": "Jardyimly, wodospady",
      "map.hirkanpark.t": "Park Narodowy Hirkan",
      "map.hirkanpark.n": "Lasy i szlaki",
      "map.sim.t": "Wodospad Sim",
      "map.sim.n": "Hirkan, piknik",
      "map.hamosham.t": "Hamoszam",
      "map.hamosham.n": "Szczyt, widoki",
      "map.qakh.t": "Kach",
    ...
    en: {
      ...
      "meta.desc":
        "Luxury trip across Azerbaijan with Tourelax — villas, VIP transport, guide. Tour July 20–30. 7500 PLN.",
      ...
      "map.gala.t": "Galah waterfall (Qalacıq)",
      "map.gala.n": "Nature and picnic",
      "map.karan.t": "Lake Karanohur",
      "map.karan.n": "Mountain lake",
      "map.qum.t": "Qum basilica",
      "map.qum.n": "5th c., Qakh area",
      "map.ilisu.t": "Ilisu",
      "map.ilisu.n": "Village, lake",
      "map.karvansaray.t": "Caravanserai",
      "map.karvansaray.n": "Sheki, Silk Road",
      "map.kishtemple.t": "Kish Albanian church",
      "map.kishtemple.n": "Early church",
      "map.kishv.t": "Kish",
      "map.kishv.n": "Village by the church",
      "map.shekipalace.t": "Khans’ Palace of Sheki",
      "map.shekipalace.n": "18th c., stained glass",
      "map.vizezemin.t": "Vizezemin",
      "map.vizezemin.n": "Lerik, village on route",
      "map.yard.t": "Nisakala canyon",
      "map.yard.n": "Yardimli, waterfalls",
      "map.hirkanpark.t": "Hirkan National Park",
      "map.hirkanpark.n": "Forests and trails",
      "map.sim.t": "Sim waterfall",
      "map.sim.n": "Hirkan, picnic stop",
      "map.hamosham.t": "Hamosham",
      "map.hamosham.n": "Summit views",
      "map.qakh.t": "Qakh",
    ...
    tr: {
      ...
      "meta.desc":
        "Tourelax ile Azerbaycan’da lüks tur — villalar, VIP ulaşım, rehber. 20–30 Temmuz. 7500 PLN.",
      "nav.label": "Ana menü",
      "nav.tour": "Tur",
      ...
      "map.gala.t": "Galaç şelalesi (Qalacıq)",
      "map.gala.n": "Doğa ve piknik",
      "map.karan.t": "Karanohur gölü",
      "map.karan.n": "Dağ gölü",
      "map.qum.t": "Kum bazilikası",
      "map.qum.n": "5. yy, Kah bölgesi",
      "map.ilisu.t": "İlisu",
      "map.ilisu.n": "Köy, göl",
      "map.karvansaray.t": "Kervansaray",
      "map.karvansaray.n": "Şeki, İpek Yolu",
      "map.kishtemple.t": "Kiş Arnavut kilisesi",
      "map.kishtemple.n": "Erken dönem kilise",
      "map.kishv.t": "Kiş",
      "map.kishv.n": "Kilisenin yanındaki köy",
      "map.shekipalace.t": "Şeki Hanlar Sarayı",
      "map.shekipalace.n": "18. yy, şebekə",
      "map.vizezemin.t": "Vizezemin",
      "map.vizezemin.n": "Lerik, rotadaki köy",
      "map.yard.t": "Nisakala kanyonu",
      "map.yard.n": "Yardımlı, şelaleler",
      "map.hirkanpark.t": "Hirkan Milli Parkı",
      "map.hirkanpark.n": "Orman ve patikalar",
      "map.sim.t": "Sim şelalesi",
      "map.sim.n": "Hirkan, piknik",
      "map.hamosham.t": "Hamoşam",
      "map.hamosham.n": "Zirve manzarası",
      "map.qakh.t": "Kah",
